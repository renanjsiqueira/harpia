...
public final class LogicSpecs {
    ...
    public static Analysis analyze(String markdown) {
        ...
        Optional<SpecAst> parsed = SpecParser.parse(source, diagnostics);
        LogicAnalyzer.Result analysis = parsed
                .map(specification -> LogicAnalyzer.analyze(List.of(specification), diagnostics))
                .orElse(new LogicAnalyzer.Result(List.of(), List.of()));
        return new Analysis(
    ...
    public record Analysis(
            Optional<SpecAst> specification,
