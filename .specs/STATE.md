...
**Blockers**: TG-03 e TG-04 continuam abertos e são provados em execução por S7. Uma decisão do usuário está pendente: a entidade da fixture **não pode se chamar `Order`** sobre Postgres (`HRP2016`, tabela reservada), e C51 nomeia `Order` entre as 15 declarações.
